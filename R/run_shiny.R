...
#' @param model name of the model to be solved. Examples of built-in models are: "SIR", "SIRvaccination", "SIS". Call 'default_models()' to view the names of all built-in models along with a short description. Default model is "SIR".
